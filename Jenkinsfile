...
pipeline {
    environment {
        ...
        APP_NAME = "ulrich"
        STG_API_ENDPOINT = "ip10-0-1-3-ch4nfvart4b0qie13q0g-1993.direct.docker.labs.eazytraining.fr"
        STG_APP_ENDPOINT = "ip10-0-1-3-ch4nfvart4b0qie13q0g-8080.direct.docker.labs.eazytraining.fr"
        PROD_API_ENDPOINT = "ip10-0-1-3-ch4nfvart4b0qie13q0g-1993.direct.docker.labs.eazytraining.fr"
        PROD_APP_ENDPOINT = "ip10-0-1-3-ch4nfvart4b0qie13q0g-80.direct.docker.labs.eazytraining.fr"
        INTERNAL_PORT = "80"
